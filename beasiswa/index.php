            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                          <a href="#" class="dropdown-toggle" style="font-weight: bold;" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Perhitungan <span class="caret"></span></a>
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li><a href="?page=model">Data bobot</a></li>
                            <li><a href="?page=penilaian">Sub Kriteria</a></li>
                            <li class="divider"></li>
                        ...
                        <li><a href="#">|</a></li>
                        <li><a href="#" style="font-weight: bold; color: purple;"><?= ucfirst($_SESSION["username"]) ?></a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
